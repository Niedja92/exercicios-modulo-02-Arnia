...
// Escreva uma função chamada calcularTotalCompra que recebe esse array de produtos e retorna o valor total da compra, levando em consideração o preço e a quantidade de cada produto. Utilize as funções map, filter e reduce para obter o resultado.

function calcularTotalCompra (produtos) {
    return produtos.reduce((acumulador, curr) => {
        return acumulador + (curr.preco * curr.quantidade)
    }, 0)
}
